...
class DataQualityMixin(object):
    ...
    caen_board_10_data_blocks = Column(Integer, unique=False)
    #caen_board_11_data_blocks = Column(Integer, unique=False)
    ...
    caen_board_10_pedestal_mean = Column(ARRAY(Float), unique=False)  # V1751, 8 channels
    #caen_board_11_pedestal_mean = Column(ARRAY(Float), unique=False)  # V1742, 32 channels
    ...
    caen_board_10_pedestal_rms = Column(ARRAY(Float), unique=False)  # V1751, 8 channels
    #caen_board_11_pedestal_rms = Column(ARRAY(Float), unique=False)  # V1742, 32 channels
    ...
    caen_board_10_adc_mean = Column(ARRAY(Float), unique=False)  # V1751, 8 channels
    #caen_board_11_adc_mean = Column(ARRAY(Float), unique=False)  # V1742, 32 channels
    ...
    caen_board_10_adc_rms = Column(ARRAY(Float), unique=False)  # V1751, 8 channels
    #caen_board_11_adc_rms = Column(ARRAY(Float), unique=False)  # V1742, 32 channels
    ...
    # CAEN board 10
    caen_board_10_channel_0_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    caen_board_10_channel_1_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    caen_board_10_channel_2_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    caen_board_10_channel_3_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    caen_board_10_channel_4_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    caen_board_10_channel_5_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    caen_board_10_channel_6_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    caen_board_10_channel_7_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)

    caen_board_10_channel_0_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    caen_board_10_channel_1_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    caen_board_10_channel_2_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    caen_board_10_channel_3_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    caen_board_10_channel_4_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    caen_board_10_channel_5_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    caen_board_10_channel_6_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    caen_board_10_channel_7_adc_histogram_counts = Column(ARRAY(Integer), unique=False)

    caen_board_10_channel_0_adc_histogram_min_bin = Column(Integer, unique=False)
    caen_board_10_channel_1_adc_histogram_min_bin = Column(Integer, unique=False)
    caen_board_10_channel_2_adc_histogram_min_bin = Column(Integer, unique=False)
    caen_board_10_channel_3_adc_histogram_min_bin = Column(Integer, unique=False)
    caen_board_10_channel_4_adc_histogram_min_bin = Column(Integer, unique=False)
    caen_board_10_channel_5_adc_histogram_min_bin = Column(Integer, unique=False)
    caen_board_10_channel_6_adc_histogram_min_bin = Column(Integer, unique=False)
    caen_board_10_channel_7_adc_histogram_min_bin = Column(Integer, unique=False)

    caen_board_10_channel_0_adc_histogram_max_bin = Column(Integer, unique=False)
    caen_board_10_channel_1_adc_histogram_max_bin = Column(Integer, unique=False)
    caen_board_10_channel_2_adc_histogram_max_bin = Column(Integer, unique=False)
    caen_board_10_channel_3_adc_histogram_max_bin = Column(Integer, unique=False)
    caen_board_10_channel_4_adc_histogram_max_bin = Column(Integer, unique=False)
    caen_board_10_channel_5_adc_histogram_max_bin = Column(Integer, unique=False)
    caen_board_10_channel_6_adc_histogram_max_bin = Column(Integer, unique=False)
    caen_board_10_channel_7_adc_histogram_max_bin = Column(Integer, unique=False)

    caen_board_10_channel_0_adc_histogram_bin_width = Column(Integer, unique=False)
    caen_board_10_channel_1_adc_histogram_bin_width = Column(Integer, unique=False)
    caen_board_10_channel_2_adc_histogram_bin_width = Column(Integer, unique=False)
    caen_board_10_channel_3_adc_histogram_bin_width = Column(Integer, unique=False)
    caen_board_10_channel_4_adc_histogram_bin_width = Column(Integer, unique=False)
    caen_board_10_channel_5_adc_histogram_bin_width = Column(Integer, unique=False)
    caen_board_10_channel_6_adc_histogram_bin_width = Column(Integer, unique=False)
    caen_board_10_channel_7_adc_histogram_bin_width = Column(Integer, unique=False)

    caen_board_10_channel_0_adc_histogram_number_bins = Column(Integer, unique=False)
    caen_board_10_channel_1_adc_histogram_number_bins = Column(Integer, unique=False)
    caen_board_10_channel_2_adc_histogram_number_bins = Column(Integer, unique=False)
    caen_board_10_channel_3_adc_histogram_number_bins = Column(Integer, unique=False)
    caen_board_10_channel_4_adc_histogram_number_bins = Column(Integer, unique=False)
    caen_board_10_channel_5_adc_histogram_number_bins = Column(Integer, unique=False)
    caen_board_10_channel_6_adc_histogram_number_bins = Column(Integer, unique=False)
    caen_board_10_channel_7_adc_histogram_number_bins = Column(Integer, unique=False)

    # CAEN board 11
    #caen_board_11_channel_0_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_1_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_2_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_3_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_4_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_5_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_6_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_7_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_8_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_9_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_10_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_11_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_12_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_13_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_14_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_15_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_16_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_17_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_18_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_19_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_20_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_21_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_22_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_23_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_24_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_25_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_26_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_27_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_28_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_29_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_30_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_31_adc_histogram_bin_indices = Column(ARRAY(Integer), unique=False)

    #caen_board_11_channel_0_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_1_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_2_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_3_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_4_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_5_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_6_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_7_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_8_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_9_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_10_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_11_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_12_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_13_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_14_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_15_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_16_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_17_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_18_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_19_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_20_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_21_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_22_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_23_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_24_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_25_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_26_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_27_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_28_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_29_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_30_adc_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_channel_31_adc_histogram_counts = Column(ARRAY(Integer), unique=False)

    #caen_board_11_channel_0_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_1_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_2_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_3_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_4_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_5_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_6_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_7_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_8_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_9_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_10_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_11_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_12_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_13_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_14_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_15_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_16_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_17_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_18_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_19_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_20_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_21_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_22_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_23_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_24_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_25_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_26_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_27_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_28_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_29_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_30_adc_histogram_min_bin = Column(Integer, unique=False)
    #caen_board_11_channel_31_adc_histogram_min_bin = Column(Integer, unique=False)

    #caen_board_11_channel_0_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_1_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_2_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_3_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_4_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_5_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_6_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_7_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_8_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_9_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_10_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_11_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_12_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_13_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_14_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_15_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_16_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_17_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_18_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_19_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_20_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_21_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_22_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_23_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_24_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_25_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_26_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_27_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_28_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_29_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_30_adc_histogram_max_bin = Column(Integer, unique=False)
    #caen_board_11_channel_31_adc_histogram_max_bin = Column(Integer, unique=False)

    #caen_board_11_channel_0_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_1_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_2_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_3_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_4_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_5_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_6_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_7_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_8_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_9_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_10_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_11_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_12_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_13_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_14_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_15_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_16_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_17_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_18_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_19_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_20_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_21_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_22_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_23_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_24_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_25_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_26_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_27_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_28_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_29_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_30_adc_histogram_bin_width = Column(Integer, unique=False)
    #caen_board_11_channel_31_adc_histogram_bin_width = Column(Integer, unique=False)

    #caen_board_11_channel_0_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_1_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_2_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_3_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_4_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_5_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_6_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_7_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_8_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_9_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_10_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_11_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_12_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_13_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_14_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_15_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_16_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_17_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_18_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_19_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_20_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_21_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_22_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_23_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_24_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_25_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_26_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_27_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_28_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_29_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_30_adc_histogram_number_bins = Column(Integer, unique=False)
    #caen_board_11_channel_31_adc_histogram_number_bins = Column(Integer, unique=False)
    ...
    caen_board_10_timestamps_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    caen_board_10_timestamps_histogram_counts = Column(ARRAY(Integer), unique=False)
    caen_board_10_timestamps_histogram_min_bin = Column(Float, unique=False)
    caen_board_10_timestamps_histogram_max_bin = Column(Float, unique=False)
    caen_board_10_timestamps_histogram_bin_width = Column(Float, unique=False)
    caen_board_10_timestamps_histogram_number_bins = Column(Integer, unique=False)

    #caen_board_11_timestamps_histogram_bin_indices = Column(ARRAY(Integer), unique=False)
    #caen_board_11_timestamps_histogram_counts = Column(ARRAY(Integer), unique=False)
    #caen_board_11_timestamps_histogram_min_bin = Column(Float, unique=False)
    #caen_board_11_timestamps_histogram_max_bin = Column(Float, unique=False)
    #caen_board_11_timestamps_histogram_bin_width = Column(Float, unique=False)
    #caen_board_11_timestamps_histogram_number_bins = Column(Integer, unique=False)
...
class DataQualityMixinA(object):
    """ Data quality mixin. """
...
class DataQualitySubRunA(DataQualityMixinA, Base):
    """ Data quality table for sub-runs. """

    # table name
    __tablename__ = 'subruns_a'
    __table_args__ = {'schema' : 'dqm'}
    ...
    def __repr__(self):
        return '<DataQualitySubRunA %r>' % (self.id)

class DataQualityRunA(DataQualityMixinA, Base):
    """ Data quality table for runs. """

    # table name
    __tablename__ = 'runs_a'
    __table_args__ = {'schema' : 'dqm'}
    ...
    def __repr__(self):
        return '<DataQualityRunA %r>' % (self.id)
